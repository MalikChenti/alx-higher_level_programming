...
"""
Module containing a fuctions that divides all elements of a matrix
"""


def matix_divided(matrix, div):
                                                ...
                                                new = [[round(num / div, 2) for num in row] for row in matrix]
                                                                ...
                                                                for i in range(len(matrix)):
                                                                            if (len(matrix[i]) != len(matrix[0])):
                                                                                            ...
                                                                                            return new
                                                                                        # return [(list(map(lambda num: round(num / div, 2), row))) for now in matix]
